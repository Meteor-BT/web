...
${props.size === "lg" ? "px-5 py-2 rounded-lg gap-2 text-base" : ""}
${props.size === "base" || !props.size ? "px-4 py-2 rounded-lg gap-2 text-sm" : ""}
${props.color === "primary" ? "text-teal-500 stroke-teal-500 border-teal-500 lg:hover:bg-teal-500/20" : ""}
...
${props.size === "lg" ? "px-5 py-2 rounded-lg gap-2 text-base" : ""}
${props.size === "base" || !props.size ? "px-4 py-2 rounded-lg gap-2 text-sm" : ""}
${props.color === "primary" ? "bg-teal-500 text-white stroke-white border-teal-500 lg:hover:bg-teal-600 lg:hover:border-teal-600" : ""}
